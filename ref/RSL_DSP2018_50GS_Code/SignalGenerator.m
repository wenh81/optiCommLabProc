...
% Signal.Rs = 10e9; % Symbol rate in Hz 2.5e9
Signal.Rs = 2.5e9; % Symbol rate in Hz 2.5e9
...
% Signal.pulse.roll_off = 1; % Roll-off of the pulses  0.1 0.9,  ### 1 for alignment ####
Signal.pulse.roll_off =0.1; % Roll-off of the pulses  0.1 0.9,  ### 1 for alignment ####
...
% Signal.Ssc = 13e9; % Sub-carrier spacing, in Hz
