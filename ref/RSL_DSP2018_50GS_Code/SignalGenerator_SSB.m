function Signal = SignalGenerator_SSB()

%-------------------------------------------------------
% signal properties
%-------------------------------------------------------
Signal.M = 16; % QAM modulation order
Signal.Rs = 6.25e9; % Symbol rate in Hz 2.5e9
...
% Signal.pulse.roll_off = 0.1; % Roll-off of the pulses  0.1 0.9,  ### 1 for alignment ####
Signal.pulse.roll_off = 0.1; % Roll-off of the pulses  0.1 0.9,  ### 1 for alignment ####
...
Signal.Ssc = 12.5e9; % Sub-carrier spacing, in Hz
% Signal.Nsc = 2; % Number of sub-carriers 2  ### 1 for alignment####
Signal.Nsc = 1; % Number of sub-carriers 2  ### 1 for alignment####
Signal.awgRs = 50e9; % Sample rate of the AWGs in Hz
...
% Signal.freq_scs = -0.125; % for SSB generation 5G/40G=-0.125, 
% Signal.freq_scs = -7.5/40; % for SSB generation 5G/40G=-0.125, 
Signal.freq_scs = -6.5/40; % for SSB generation 5G/40G=-0.125, 
